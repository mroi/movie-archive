...
public indirect enum MediaTree: Sendable {
...
extension MediaTree {
	...
	public struct AssetNode: Identifiable, Sendable {
		public let id: ID
	...
	public struct MenuNode: Identifiable, Sendable {
		public let id: ID
	...
	public struct LinkNode: Sendable {
	...
	public struct OpaqueNode: Identifiable, Sendable {
		public let id: ID
...
public struct MediaRecipe: Sendable {
